                    ...
                    <div className="card">
                        ...
                        <div className="mid-container">
                            <div className="left-container">
                                <div>
                                    <div class="heading"><h2>Hey, I am</h2></div>
                                    <div class="website-name"><h1>AIcruiter</h1></div>
                                    <div class="tagline"><h3>I will make sure that you prepare well ! </h3></div>
                                    <div className="left-btn-container">
                                        <button className="btn1">Start your preparation</button>
                        ...
                        <div className="bottom-container">
                                <div class="bottom-search-container">
                                    ...
                                    <div class="button">
                                        <div class="button-text">Search Now</div>
                                    </div>
                                </div>
                        </div>
                    </div>
